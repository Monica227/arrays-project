...
ages.push(3) //Array name + .push added the following numbers to my array.
ages.push(9)
ages.push(23)
ages.push(64)
ages.push(2)
...
console.log(lastelement - firstelement); //Values of the last and first element in the array were programtically subtracted.

//1b.	Add a new age to your array and repeat the step above to ensure it is dynamic. (works for arrays of different lengths).
var age = [];
ages.push(27) //array name + .push adds the new age to the existing array.
console.log("This is my ages array and me adding a new age to it;", ages); //New age is printed in the console in the current array.
...
for (let i =0; i < ages.length; i++){
    console.log(ages[i])
    sum = sum + ages[i]
} console.log("Sum of numbers in the array;" , sum) //Sum of ages.
console.log("This is the average of the ages;", sum/ages.length) //Sum of ages divided by number of ages to get the average.
...
console.log(count); 
var averageLetters = count / names.length; //Count of letters is divided by the total number of letters in the entire array.
...
console.log("This is the sum of all the elements in the array;", nameSums);
...
repeatGreeting("Hello", 4); //Function returns the greeting 4 times.  
...
console.log("This will print the fullname;", fullName(firstName, lastName));
...
} console.log("This is the average of the elements in the array;", average(numbers));
...
console.log("The average of array 1 is greater than the average of array 2;" , greaterAverage());
...
}console.log(willBuyDrink(isHotOutside, moneyInPocket)); //Returned true.
...
console.log(greaterNum( 35, 150)); //150 is larger than 35 so the function worked successfully. 